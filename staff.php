...
<body ><div align="center">
   ...
   <br />
    ...
    <br />
       <br />
    <strong><font color="#0000" size="3" face="Georgia, Arial, Helvetica, sans-serif"> Staff and Students
    Updation<br /></font></strong></div>
    <br /><font color="#0000" size="3" face="Georgia, Arial, Helvetica, sans-serif">
    <form method="GET" action="staffupdate.php" onSubmit="return fCheck(this);"><table align="center"><tr></tr><tr></tr><tr><td>
  Department </td><td></td>
<td>    <select id="dept" name="dept">
    ...
    </select></td></tr> <tr></tr> <tr></tr> <tr></tr> <tr></tr><td>
  Section </td><td></td><td><select name="sec" id="sec">
	...
	<center><input type="submit" name="submit" value="Submit" id="submit"></form>
   <br /><br /><br /><br /><br /><br /><br />
	<br /><a href="index.php">Home</a></font>
    <br /></center>
