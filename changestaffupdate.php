...
$sqm="select * from staff where username='".$username1."';";
$result=mysql_query($sqm);
$row=mysql_fetch_array($result);
if($row[1]==$password1){

$sql="delete from staff where username='".$username1."' and password='".$password1."';";
mysql_query($sql);

$sql="insert into staff values('".$username2."','".$password2."');";
mysql_query($sql);
